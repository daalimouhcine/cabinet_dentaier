        ...
        <nav className="py-2 px-6 bg-blue-100 mb-6">
            <div className="w-5/6 flex justify-between mx-auto">
                ...
                <ul className="flex items-center">
                    ...
                    <li className="p-3">
                    <a href="#_" className="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-gray-600 whitespace-no-wrap bg-white border border-gray-200x rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:shadow-none">
