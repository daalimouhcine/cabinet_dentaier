            ...
            <div className="flex flex-col items-start space-y-8 tracking-tight lg:max-w-3xl">
              <div className="relative">
                ...
                <h2 className="text-5xl font-bold text-gray-900 xl:text-6xl">
                  Features to help you take appointments
                </h2>
              </div>
              <p className="text-2xl text-gray-700">
                We've created a simple appointment website in order to
                facilitate the proses of taking appointment at the dentist.
              </p>
              {!isSubmitted ? (
                <a
                  href="#_"
